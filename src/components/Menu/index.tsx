...
export function Menu({ onOpenNewTaskModal }: Taskprops){
    return (
        <Container>
                ...
                <MenuList>
                    <Link to={'/'}><MenuImg src={dashboardLeftImg} alt="Dashboard" /></Link>
                    <Link to={'/task'}><MenuImg src={taskImg} alt="Task" /></Link>
                    
                    {/* <img src={calendar} alt="Calendar" /> */}
                    <MenuImg src={newtaskImg} alt="Add New Task" onClick={onOpenNewTaskModal}/>
                </MenuList>
